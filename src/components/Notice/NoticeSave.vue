...
<template>
  <div>
    ...
    <div class="oper-group">
      ...
      <Button type="primary" @click="handleEvent('del')">删除公告</Button>
    </div>
    ...
    <Modal v-model="myModal" :title="modalTitle" :mask-closable="false">
      ...
      <div slot="footer">
        <Button  v-if="currentModal==='del'" type="primary" @click="deleteData">确定</Button>
  ...
  export default {
    ...
    methods:{
      ...
      handleEvent:function (str,row) {
        ...
        this.modalTitle = str === 'read' ? '公告-阅读回执' : str === 'del' ? '公告-删除' :  '公告-查看';
        this.myModal = true;
      }
    },
    mounted(){
