<template>
  <div class="schedule-my">
    <div class="calendar-top">
      <div class="left">
        <Button type="primary" @click="goCheck('pre')">前一周</Button>
        <Button type="primary" @click="goCheck('now')">当前周</Button>
        <Button type="primary" @click="goCheck('next')">后一周</Button>
      </div>
...
<style>
  ...
  .schedule-my .overview{
    display: flex;
    align-items: center;
  }
  .schedule-my .overview>div{
    flex: 1;
  }
  .schedule-my .overview>div>div{
    height: 100px;
    border: 1px solid #ddd;
  }
  .schedule-my .overview>div>p{
    border: 1px solid #ddd;
  }
